package edu.rosehulman.conefinder;
...
public class ConeFinderActivity extends Activity implements CvCameraViewListener2{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Temporary test to see if the TextView are all connected right.
